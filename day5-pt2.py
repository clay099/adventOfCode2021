...
def next_diagonal_position(val1, val2, i):
    return val1 - i if val1 > val2 else val1 + i


def add_diagonal_line(x1, x2, y1, y2):
    diagonal_length = abs(x1 - x2) + 1
    for i in range(diagonal_length):
        x = next_diagonal_position(x1, x2, i)
        y = next_diagonal_position(y1, y2, i)
